...
%  R is the reference siggnal for lane change right or left

S = xlsread('C:\Users\scuwa\Desktop\MA_Jiawei\Data\Ergebnisse-1023.xls','Ergebnisse-1023','A:A');      
R_lcr = xlsread('C:\Users\scuwa\Desktop\MA_Jiawei\Data\Reference_Signale.xlsx','RS_SWnR','A:A');
...
%%  Labeling (lane change right, lane chang left, lane keeping)     
    ...
    elseif d_lcl <= th_value_lcl
         label = -1 ;      % 1 means lane change right does not happens
         d = d_lcl ;
    else
         label = 0;
         d = 0;
   ...
   I = xlswrite('C:\Users\scuwa\Desktop\MA_Jiawei\Data\Dtw_Ergebnis.xlsx',nrOfLoop ,'Label_ego',str2);
   St1 = xlswrite('C:\Users\scuwa\Desktop\MA_Jiawei\Data\Dtw_Ergebnis.xlsx',start_time ,'Label_ego',str3);
   St2 = xlswrite('C:\Users\scuwa\Desktop\MA_Jiawei\Data\Dtw_Ergebnis.xlsx',stop_time ,'Label_ego',str4);
   E = xlswrite('C:\Users\scuwa\Desktop\MA_Jiawei\Data\Dtw_Ergebnis.xlsx',d ,'Label_ego',str5);
   Labeling = xlswrite('C:\Users\scuwa\Desktop\MA_Jiawei\Data\Dtw_Ergebnis.xlsx',label ,'Label_ego',str6);
   m = m + shift ;
   n = n + shift ;
   nrOfLoop = nrOfLoop + 1 ;
   k = k + 1;   
