...
for L = 1:nrOfLoop
   ...
   R = xlsread('C:\Users\scuwa\Desktop\MA_Jiawei\Data\Reference_Signale.xlsx','RS_SWnL','A4:A650');
   w = 1000;
   M = length(S);
   N = length(R);
...
%% DTW initiation
   ...
   I = xlswrite('C:\Users\scuwa\Desktop\MA_Jiawei\Data\Dtw_Ergebnis.xlsx',L ,'E_SWnL',str3);
   E = xlswrite('C:\Users\scuwa\Desktop\MA_Jiawei\Data\Dtw_Ergebnis.xlsx',d ,'E_SWnL',str2);
   m = m + windLen;
   n = n + windLen;
   k = k + 1;
