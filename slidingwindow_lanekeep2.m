...
for L = 1:nrOfLoop
   ...
   R = xlsread('C:\Users\scuwa\Desktop\MA_Jiawei\Data\Reference_Signale.xlsx','RS_Spurhalten2','A4:A504');
   w = 1000;
   M = length(S);
   N = length(R);
...
%% DTW initiation
   ...
   I = xlswrite('C:\Users\scuwa\Desktop\MA_Jiawei\Data\Dtw_Ergebnis.xlsx',L ,'E_Spurhalten2',str3);
   E = xlswrite('C:\Users\scuwa\Desktop\MA_Jiawei\Data\Dtw_Ergebnis.xlsx',d ,'E_Spurhalten2',str2);
   m = m + windLen;
   n = n + windLen;
   k = k + 1;
